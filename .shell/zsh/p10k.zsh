# Generated by Powerlevel10k configuration wizard on 2021-02-06 at 20:54 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_FOREGROUND=210
  ...
  # jmroca: This is to force the name of the env to be as the folder where it was installed (not its parent)
  typeset -g _POWERLEVEL9K_VIRTUALENV_GENERIC_NAMES=''
